 ...
 */
public class ListThreadsConcurency implements Runnable {
    private ArrayList<Integer> _stageOne = new ArrayList<>();
    private ArrayList<Integer> _stageTwo = new ArrayList<>();
    private Object _stageOneLocker = new Object();
    private Object _stageTwoLocker = new Object();

    private Random random = new Random();
    private int _counter;

    public void stageOne() throws InterruptedException {
        synchronized (_stageOneLocker) {
